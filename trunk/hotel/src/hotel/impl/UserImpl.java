 ...
 *   <li>{@link hotel.impl.UserImpl#getNick <em>Nick</em>}</li>
...
public class UserImpl extends MinimalEObjectImpl.Container implements User {
	 ...
	 * @ordered
	 */
	protected static final Role ROLE_EDEFAULT = Role.CUSTOMER;
	...
	public void setNick(String newNick) {
		...
		nick = newNick;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HotelPackage.USER__NICK, oldNick, nick));
	}
