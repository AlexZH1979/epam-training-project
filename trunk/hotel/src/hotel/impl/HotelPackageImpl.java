...
public class HotelPackageImpl extends EPackageImpl implements HotelPackage {
	 ...
	 * @generated
	 */
	public EReference getRoomOrder_Room() {
	 ...
	 * @generated
	 */
	public EReference getRoom_Hotel() {
	 ...
	 * @generated
	 */
	public EAttribute getRoom_PricePerDay() {
	 ...
	 * @generated
	 */
	public EAttribute getEvent_NewAttribute() {
	...
	public void createPackageContents() {
		...
		createEReference(roomOrderEClass, ROOM_ORDER__ROOM);
		...
		createEReference(roomEClass, ROOM__HOTEL);
		createEAttribute(roomEClass, ROOM__ROOM_NAME);
		createEAttribute(roomEClass, ROOM__PRICE_PER_DAY);
		...
		createEAttribute(eventEClass, EVENT__NEW_ATTRIBUTE);
	...
	public void initializePackageContents() {
		...
		initEReference(getHotelUnit_RoomList(), this.getRoom(), this.getRoom_Hotel(), "roomList", null, 0, -1, HotelUnit.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRoomOrder_Room(), this.getRoom(), null, "room", null, 1, 1, RoomOrder.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRoom_Id(), ecorePackage.getEInt(), "id", null, 0, 1, Room.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRoom_Hotel(), this.getHotelUnit(), this.getHotelUnit_RoomList(), "hotel", null, 1, 1, Room.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRoom_RoomName(), ecorePackage.getEString(), "roomName", null, 1, 1, Room.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRoom_PricePerDay(), ecorePackage.getEInt(), "pricePerDay", null, 0, 1, Room.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getRoom_Description(), theXMLTypePackage.getString(), "description", null, 0, 1, Room.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRoom_Size(), theXMLTypePackage.getByte(), "size", null, 1, 1, Room.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getEvent_NewAttribute(), this.getEventStatus(), "newAttribute", "unknown", 0, 1, Event.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(userRoleEEnum, UserRole.CUSTOMER);
		addEEnumLiteral(userRoleEEnum, UserRole.ADMINISTRATOR);

		initEEnum(eventStatusEEnum, EventStatus.class, "EventStatus");
		addEEnumLiteral(eventStatusEEnum, EventStatus.BAD_BEHAVIOR);
		addEEnumLiteral(eventStatusEEnum, EventStatus.UNKNOWN);
